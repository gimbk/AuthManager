package com.microservice.authManager.Message;
...
public class CustomMessage {
    ...
    public static final String USERNAME_EXIST = "Error: Username is already in use!";
    public static final String DELETE= "Delete was successfully done!";
    public static final String CYCLEPENDING= " cycle est deja en cours bien vouloir le cloturer avant d'en creer un nouveau";
    public static final String REGISTER_FAILED= "Register failed please choose a role to register a user";
}
